...
export const WatchlistProvider: React.FC<WatchlistProviderProps> = ({ children }) => {
  ...
  const [visitorEntries, setVisitorEntries] = useState<VisitorEntry[]>([
    ...
    },
    {
      id: '3',
      name: 'Jennifer Chen',
      email: 'jennifer.chen@consulting.com',
      phone: '555-0234',
      status: 'Validated',
      date: '2024-06-17',
      ...
      host: 'Michael Brown',
      hostEmail: 'michael.brown@company.com',
      hostPhone: '555-0400',
    ...
    },
    {
      ...
      date: '2024-06-18',
      arrival: '9:30 AM EST',
      departure: '11:30 AM EST',
      host: 'Lisa Davis',
      hostEmail: 'lisa.davis@company.com',
      hostPhone: '555-0500',
      hostCompany: 'Security Firm',
    ...
    },
    {
      ...
      date: '2024-06-17',
      arrival: '8:30 AM EST',
      departure: '4:30 PM EST',
      host: 'David Thompson',
      hostEmail: 'david.thompson@company.com',
      hostPhone: '555-0600',
      hostCompany: 'Strategic Partners',
    ...
    },
    {
      id: '6',
      name: 'James Miller',
      email: 'james.miller@partner.com',
      phone: '555-0890',
      status: 'No show',
      date: '2024-06-16',
      arrival: '2:00 PM EST',
      ...
      host: 'Rachel Green',
      hostEmail: 'rachel.green@company.com',
      hostPhone: '555-0700',
      hostCompany: 'Marketing Agency',
      hostCompanyLocation: '1500 Technology Drive, 7th Floor, Austin, TX',
      floor: 'Floor 7',
      watchlistMatch: true,
      watchlistLevelId: 'low-priority'
    },
    {
      id: '7',
      name: 'Sarah Wilson',
      ...
      departure: '5:00 PM EST',
      host: 'Tom Wilson',
      hostEmail: 'tom.wilson@company.com',
      hostPhone: '555-0800',
      hostCompany: 'Construction Co',
    ...
    },
    {
      ...
      email: 'daniel.rodriguez@vendor.com',
      phone: '555-0456',
      status: 'Upcoming',
      date: '2024-06-18',
      ...
      host: 'Anna Martinez',
      hostEmail: 'anna.martinez@company.com',
      hostPhone: '555-0900',
      hostCompany: 'Vendor Solutions',
      hostCompanyLocation: '1500 Technology Drive, 6th Floor, Austin, TX',
      floor: 'Floor 6',
      watchlistMatch: false
    },
    {
      ...
      departure: '5:00 PM EST',
      host: 'Carlos Lopez',
      hostEmail: 'carlos.lopez@company.com',
      hostPhone: '555-1000',
      hostCompany: 'Internal Team',
      hostCompanyLocation: '1500 Technology Drive, 9th Floor, Austin, TX',
      floor: 'Floor 9',
      watchlistMatch: true,
    ...
    },
    {
      ...
      hostEmail: 'jennifer.taylor@company.com',
      hostPhone: '555-1100',
    ...
    },
    {
      id: '11',
      name: 'Lisa Thompson',
      email: 'lisa.thompson@client.com',
      phone: '555-0678',
      status: 'Checked in',
      date: '2024-06-17',
      ...
      host: 'Mark Johnson',
      hostEmail: 'mark.johnson@company.com',
      hostPhone: '555-1200',
    ...
    },
    {
      ...
      host: 'Susan White',
      hostEmail: 'susan.white@company.com',
      hostPhone: '555-1300',
      hostCompany: 'Vendor Management',
      hostCompanyLocation: '1500 Technology Drive, 4th Floor, Austin, TX',
      floor: 'Floor 4',
      watchlistMatch: true,
      watchlistLevelId: 'medium-priority'
    },
    {
      id: '13',
      name: 'Amanda Jackson',
      email: 'amanda.jackson@external.com',
      phone: '555-1123',
      status: 'Validated',
      date: '2024-06-17',
      arrival: '4:00 PM EST',
      departure: '6:00 PM EST',
      host: 'Robert Davis',
      hostEmail: 'robert.davis@company.com',
      hostPhone: '555-1400',
      hostCompany: 'External Relations',
    ...
    },
    {
      ...
      host: 'Paul Anderson',
      hostEmail: 'paul.anderson@company.com',
      hostPhone: '555-1500',
      hostCompany: 'Client Relations',
    ...
    },
    {
      ...
      host: 'Karen Miller',
      hostEmail: 'karen.miller@company.com',
      hostPhone: '555-1600',
      hostCompany: 'IT Contractors',
      hostCompanyLocation: '1500 Technology Drive, 2nd Floor, Austin, TX',
      floor: 'Floor 2',
      watchlistMatch: true,
      watchlistLevelId: 'high-risk',
      approvalStatus: 'pending'
